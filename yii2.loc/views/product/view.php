                    ...
                    <div class="col-sm-5">
                        ...
                        <div id="similar-product" class="carousel slide" data-ride="carousel">
                            ...
                            <?php $count = count($gallery); $i = 0; foreach ($gallery as $img):?>
                                ...
                                <?php endif;?>
                                    <a href="#" class="view-product" data-id="<?=$product->id?>"><?= Html::img($img->getUrl(), ['alt' => '','class' => 'imagel'])?></a>
                    ...
                    <div class="col-sm-7">
                        <div class="product-information"><!--/product-information-->
                            ...
                            <span>
									...
									<a href="<?=\yii\helpers\Url::to(['cart/add', 'id' => $product->id])?>" data-id="<?=$product->id?>"
